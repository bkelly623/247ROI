...
export const CTA_LABEL_NAV = "Start AI Opportunity Audit";
export const HERO_PRIMARY_CTA_LABEL = "Start AI Opportunity Audit";
...
export const CTA_MICRO = "Starts with one bottleneck worth fixing.";
