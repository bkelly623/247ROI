...
export default function ChatWidget() {
  ...
  async function send() {
    ...
    try {
      ...
      const reply =
        data.reply ??
        `Sorry — I couldn't respond right now. Start the Business Systems Audit / AI Opportunity Audit at /ai-opportunity-audit, or call or text ${PRIMARY_PHONE_DISPLAY}.`;
      ...
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          content: `Something went wrong. Start the Business Systems Audit / AI Opportunity Audit at /ai-opportunity-audit, or call or text ${PRIMARY_PHONE_DISPLAY}.`,
        },
      ]);
    } finally {
      setIsLoading(false);
