        ...
        >
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-7 sm:p-10">
            ...
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
              We inspect one real workflow, identify whether it needs automation, an AI agent, a dashboard, or a custom
              app, and define what should stay under human approval.
            </p>
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              {["Scattered data", "Repeated computer work", "Human approval"].map((item) => (
          ...
          <div className="rounded-3xl border border-primary/20 bg-primary/10 p-7 sm:p-10">
            ...
            <h3 className="mt-3 font-display text-2xl font-bold">Map the first useful system.</h3>
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              No generic pitch. We will talk through the bottleneck and decide what kind of practical system is worth building.
            </p>
